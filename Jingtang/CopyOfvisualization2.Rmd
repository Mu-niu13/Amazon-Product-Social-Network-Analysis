...
```{r}
m <- fastgreedy.community(music.network)
m
```
...
```{r adj_matrix_plot, fig.width=10, fig.height=8}
# Assuming you have a subgraph 'music.network'
adj_matrix <- as_adjacency_matrix(music.network, sparse = FALSE)
print(adj_matrix)

# Plot the adjacency matrix
image(adj_matrix, main = "Adjacency Matrix", xlab = "Nodes", ylab = "Nodes")
...
# Plot the reordered adjacency matrix
image(adj_matrix_reordered, main = "Reordered Adjacency Matrix", xlab = "Nodes", ylab = "Nodes")
...
layout <- layout_with_fr(music.network, niter=2000)

# Plot the network with community colors
V(music.network)$label <- V(music.network)$name
plot(communities, music.network, layout=layout, vertex.size=15, edge.arrow.size=0.5, edge.width=1, main="Music Network Communities")
...
communities_louvain <- cluster_louvain(undirected_music_network)
communities_infomap <- cluster_infomap(undirected_music_network)
...
print(paste("Modularity (Walktrap):", modularity_value))
print(paste("Modularity (Louvain):", modularity_louvain))
print(paste("Modularity (Infomap):", modularity_infomap))

# Visualize different community structures
par(mfrow=c(1, 3))
plot(communities, music.network, vertex.size=5, vertex.label=NA, main="Walktrap")
plot(communities_louvain, music.network, vertex.size=5, vertex.label=NA, main="Louvain")
plot(communities_infomap, music.network, vertex.size=5, vertex.label=NA, main="Infomap")
