...
We visualized subgraphs for the Music, Book, Video, and DVD categories using tools like the Plotly package in R. These visualizations revealed dense connections and distinct clusters, reflecting co-purchasing patterns within each category. For instance, the Music subgraph showed overlapping demographics across various genres, while the Book subgraph highlighted strong links between non-fiction and history genres. Analyzing these visualizations provided insights into customer preferences and potential opportunities for cross-selling.
