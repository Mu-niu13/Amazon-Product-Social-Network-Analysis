...
The study of co-purchase networks provides valuable insights into customer purchasing behavior, product relationships, and potential opportunities for targeted marketing strategies. In this paper, we analyze the co-purchase networks of four distinct product categories: Music, Book, Video, and DVD. Using various network metrics, we examine the structural properties and influential nodes within each network to understand the connectivity and influence patterns.
...
-   J. Leskovec, L. Adamic and B. Adamic. [The Dynamics of Viral Marketing](http://www.cs.cmu.edu/~jure/pubs/viral-tweb.pdf). ACM Transactions on the Web (ACM TWEB), 1(1), 2007.
